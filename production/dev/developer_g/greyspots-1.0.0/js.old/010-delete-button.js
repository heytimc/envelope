...
window.addEventListener('design-register-element', function () {
    ...
    registerDesignSnippet('<gs-delete-button>', '<gs-delete-button>', 'gs-delete-button>${1}</gs-delete-button>');
    
    designRegisterElement('gs-delete-button', '/v1/dev/developer_g/greyspots-' + GS.version() + '/tools/documentation/doc-elem-delete-button.html');
    
    window.designElementProperty_GSDELETEBUTTON = function(selectedElement) {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    xtag.register('gs-delete-button', {
        lifecycle: {
            ...
            created: function() {
                ...
                element.addEventListener('click', function (event) {
                    ...
                    if (element.hasAttribute('value')) {
                        ...
                        GS.dialog({
                            'header': 'Are you sure...',
                            'content': '<center>Are you sure you want to delete?</center>',
                            'buttons': ['No', 'Yes'],
                            'padded': true,
                            'after_close': function (event, strAnswer) {
                                if (strAnswer === 'Yes') {
                ...
                if (strKey) {
                    if (GS.keyCode(strKey)) {
                        if (strKey.match(/[arfcvxzntypq]/gim)) {
                            console.warn('gs-delete-button Warning: by setting the hot key of this button to "' + strKey + '" you may be overriding browser functionality.', this);
                        }
                        ...
                        console.error('gs-delete-button Error: \'key="' + strKey + '"\' is not a valid hot-key.', this);
                    }
                }
            },
