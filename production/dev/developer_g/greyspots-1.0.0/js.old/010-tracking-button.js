                ...
                if (strKey) {
                    if (GS.keyCode(strKey)) {
                        if (strKey.match(/[arfcvxzntypq]/gim)) {
                            console.warn('gs-tacking-button Warning: by setting the hot key of this button to "' + strKey + '" you may be overriding browser functionality.', this);
                        }
                        ...
                        console.error('gs-tacking-button Error: \'key="' + strKey + '"\' is not a valid hot-key.', this);
                    }
                }
            },
