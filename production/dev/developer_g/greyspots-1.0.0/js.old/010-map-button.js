            ...
            created: function() {
                ...
                this.addEventListener('click', function (event) {
                    ...
                    if (this.hasAttribute('value') === true) {
                        ...
                        if (this.hasAttribute('google') === true) {
                            window.open('https://maps.google.com/maps?q=' + number);
                        } else if (this.hasAttribute('bing') === true) {
                ...
                if (strKey) {
                    if (GS.keyCode(strKey)) {
                        if (strKey.match(/[arfcvxzntypq]/gim)) {
                            console.warn('gs-map-button Warning: by setting the hot key of this button to "' + strKey + '" you may be overriding browser functionality.', this);
                        }
                        ...
                        console.error('gs-map-button Error: \'key="' + strKey + '"\' is not a valid hot-key.', this);
                    }
                }
            },
