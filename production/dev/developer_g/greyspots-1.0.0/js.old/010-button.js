                ...
                if (strKey) {
                    if (GS.keyCode(strKey)) {
                        if (strKey.match(/[arfcvxzntypq]/gim)) {
                            console.warn('gs-button Warning: by setting the hot key of this button to "' + strKey + '" you may be overriding browser functionality.', this);
                        }
                        ...
                        console.error('gs-button Error: \'key="' + strKey + '"\' is not a valid hot-key.', this);
                    }
                }
            },
        ...
        methods: {
            refreshAnchor: function () {
                if (this.getAttribute('href')) {
                    ...
                    this.anchorElement.setAttribute('gs-dynamic', '');
                    this.anchorElement.setAttribute('target', this.getAttribute('target') || '_blank');
                    this.anchorElement.setAttribute('href', this.getAttribute('href'));
                    //this.anchorElement.textContent = 'A';
                    
                    this.appendChild(this.anchorElement);
                    
                } else if (this.anchorElement) {
                    this.removeChild(this.anchorElement);
                }
            }
        }
    });
