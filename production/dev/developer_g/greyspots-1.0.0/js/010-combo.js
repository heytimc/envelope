...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function getData(element, bolInitalLoad, bolClearPrevious, callback) {
        var data, strLink, dataFunction,
            strInitalize = queryStringTemplate(element, decodeURIComponent(element.getAttribute('initialize') || '')),
            strSource = queryStringTemplate(element, decodeURIComponent(element.getAttribute('src') ||
        ...
        strLink += '&where='    + encodeURIComponent(queryStringTemplate(element, decodeURIComponent(element.getAttribute('where') || ''))) +
                   '&limit='    + encodeURIComponent(queryStringTemplate(element, decodeURIComponent(element.getAttribute('limit') || ''))) +
                   '&offset='   + encodeURIComponent(queryStringTemplate(element, decodeURIComponent(element.getAttribute('offset') || ''))) +
                   '&order_by=' + encodeURIComponent(queryStringTemplate(element, decodeURIComponent(element.getAttribute('ord') || ''))) +
    ...
    function queryStringTemplate(element, template) {
