window.addEventListener('design-register-element', function () {
    ...
    designRegisterElement('gs-time', '/v1/dev/developer_g/greyspots-' + GS.version() + '/tools/documentation/doc-elem-time.html');
    ...
    window.designElementProperty_GSTIME = function(selectedElement) {
        ...
        addProp('Display Format', true, '<gs-select class="target" value="' + (selectedElement.getAttribute('format') || '') + '" mini>' +
        ...
        addProp('Output Format', true, '<gs-select class="target" value="' + (selectedElement.getAttribute('output-format') || '') + '" mini>' +
                                    '<option value="">Regular (1:30 PM)</option>' +
                                    '<option value="military">Military (13:30)</option>' +
                                '</gs-select>', function () {
    ...
    function translateValue(strFormat, newValue) {
        ...
        if (typeof newValue === 'string') {
            ...
            if (newValue) {
                ...
                // else (if there are just numbers)
                    ...
                    // else: 
                        ...
                        if ((strFormat === 'military') && newValue > 24 ||
                            (strFormat !== 'military') && newValue > 12) {
            ...
            if (strHour && strMinute) {
                valueDate = new Date('1/1/1111 ' + strHour + ':' + strMinute + (strPeriod ? ' ' + strPeriod : ''));
            }
                    ...
                    */});
                    ...
                    pickerElement.addEventListener('click', function (event) {
                        ...
                        if (target.classList.contains('increment-time') && element.getAttribute('value')) {
                            ...
                            newValue = '';
                        } else if (target.classList.contains('modal-done')) {
                            element.close();
                        }
